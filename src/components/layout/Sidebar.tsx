    ...
    <aside className="fixed left-0 top-0 bottom-0 w-64 bg-prospex-surface border-r border-prospex-border flex flex-col z-50">
      ...
      <div className="p-5 border-b border-prospex-border">
        <Link href="/" className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-mono font-bold text-base text-prospex-text tracking-tight">
              PROSPEX
            </h1>
            <p className="text-[10px] text-prospex-dim font-mono tracking-widest uppercase">
              Find. Score. Close.
            </p>
          </div>
        </Link>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-prospex-cyan/10 text-prospex-cyan border border-prospex-cyan/20 shadow-glow-cyan'
                  : 'text-prospex-muted hover:text-prospex-text hover:bg-prospex-bg border border-transparent'
              )}
            >
      ...
      <div className="p-4 border-t border-prospex-border">
        ...
        <p className="text-[10px] font-mono text-prospex-dim mt-1">Prospex v1.0</p>
      </div>
    </aside>
  );
}
